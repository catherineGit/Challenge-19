...
candidate_database = {
    "Lane": [
        "Lane",
        "0x6e0313aE23195DfC81f324013271CF9d01438a9e",
        "4.3",
        0.20,
        "Images/lane.jpeg",
    ],
    "Ash": [
        "Ash",
        "0x117780C2b29C59ccDed3e2c856c1c04b73BDb0B4",
        "5.0",
        0.33,
        "Images/ash.jpeg",
    ],
    "Jo": [
        "Jo",
        "0xB76a41E2fb013C67D54a4fce5F64d5b8AD741D9b",
        "4.7",
        0.19,
        "Images/jo.jpeg",
    ],
    "Kendall": [
        "Kendall",
        "0xC068767B95236F752d2dB74472fF567C39134A12",
        "4.1",
        0.16,
        "Images/kendall.jpeg",
    ],
...
st.text(" \n")
#st.write(w3.is_connected())
#st.write(w3.eth.get_balance("0x90e63c3d53E0Ea496845b7a03ec7548B70014A91"))
################################################################################
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3,account, candidate_address, wage, pk)
